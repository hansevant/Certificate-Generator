    ...
    <body>
        <div class="container">
            <center>
                <h2 class="my-3">Certificate Generator made with php</h2>
                ...
                <form action="" method="post">
                    ...
                    <div class="col-xl-5 col-sm-7 mt-3">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" name="name" placeholder="Kimi no Na wa" aria-describedby="button-addon2">
